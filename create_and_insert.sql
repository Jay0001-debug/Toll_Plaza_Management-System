...
-- ============================================================
-- 12. TRANSACTION_PASS (M:N junction)
-- ============================================================
CREATE TABLE Transaction_Pass (
    Transaction_ID  INT,
    Pass_ID         INT,
    PRIMARY KEY (Transaction_ID, Pass_ID),
    FOREIGN KEY (Transaction_ID)  REFERENCES Transaction(Transaction_ID),
    FOREIGN KEY (Pass_ID)         REFERENCES Monthly_Pass(Pass_ID)
);

-- ============================================================
-- 13. TRANSACTION_FASTAG (M:N junction)
-- ============================================================
CREATE TABLE Transaction_FASTag (
    Transaction_ID  INT,
    Fastag_ID       INT,
    PRIMARY KEY (Transaction_ID, Fastag_ID),
    FOREIGN KEY (Transaction_ID)  REFERENCES Transaction(Transaction_ID),
    FOREIGN KEY (Fastag_ID)       REFERENCES FASTag_Account(Fastag_ID)
);

-- ============================================================
-- 14. TRANSACTION_RATE (M:N junction)
-- ============================================================
CREATE TABLE Transaction_Rate (
    Transaction_ID  INT,
    Plaza_ID        INT,
    Vehicle_Type    VARCHAR(50),
    PRIMARY KEY (Transaction_ID, Plaza_ID, Vehicle_Type),
    FOREIGN KEY (Transaction_ID)          REFERENCES Transaction(Transaction_ID),
    FOREIGN KEY (Plaza_ID, Vehicle_Type)  REFERENCES Toll_Rate(Plaza_ID, Vehicle_Type)
);
...
-- ============================================================
-- 10. TRANSACTION_PASS (Transaction linked to Monthly Pass)
-- ============================================================
INSERT INTO Transaction_Pass (Transaction_ID, Pass_ID) VALUES
(601, 501),
(604, 503),
(607, 502),
(611, 501),
...
-- ============================================================
-- 11. TRANSACTION_FASTAG (Transaction linked to FASTag)
-- ============================================================
INSERT INTO Transaction_FASTag (Transaction_ID, Fastag_ID) VALUES
(602, 402),
(605, 404),
(606, 408),
(608, 406),
...
-- ============================================================
-- 12. TRANSACTION_RATE (Transaction linked to Toll Rate)
-- ============================================================
INSERT INTO Transaction_Rate (Transaction_ID, Plaza_ID, Vehicle_Type) VALUES
(602, 1, 'Truck'),
(603, 1, 'Motorcycle'),
(605, 2, 'Car'),
(606, 2, 'Truck'),
